...
`binding-hash.json` provides repository-level, non-normative, byte-identical
known-answer vectors for the `binding_hash` construction defined by the
[Access Request Approval profile](../../../profiles/authzen-access-request-approval/authzen-access-request-approval-profile-1_0.md#binding-token-integrity).
...
```sh
node interop/test-vectors/binding-hash/verify-binding-hash-vectors.mjs
```
