...
> Note: These payloads and corresponding interop results are for the [AuthZEN 1.0 Draft 01 (First Implementers Draft)](https://openid.net/specs/authorization-api-1_0-01.html) version of the spec.
