...
Interop results for the [EmpowerID](https://www.empowerid.com/) implementation hosted at `https://authzen-demo.eidlabs.net`.

## Test results

```bash
yarn test https://authzen-demo.eidlabs.net authorization-api-1_0-01 markdown
yarn run v1.22.22
$ node build/test/runner.js https://authzen-demo.eidlabs.net authorization-api-1_0-01 markdown
```
<table>
  <tr>
    <th>result</th>
