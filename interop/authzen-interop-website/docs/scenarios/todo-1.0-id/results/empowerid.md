...
```bash
yarn test https://authzen-demo.eidlabs.net 1.0-implementers-draft markdown
yarn run v1.22.22
$ node build/test/runner.js https://authzen-demo.eidlabs.net 1.0-implementers-draft markdown
```
<table>
  <tr>
    <th>result</th>
